...
<head>
	<meta charset="UTF-8">
	<title>BPBD | Data Laporan Pengungsi</title>
...
<body>
	...
	<div class="container-fluid">
		<div class="row p1 m-3 border rounded-lg shadow-lg " style="background-color: #958B8B">
			<div class="col-lg-12">
				<div class="judul">
					<h5 class="font-weight-bold">Data Laporan Pengungsi</h5>
				</div>
			</div>
		</div>
		...
		<td>
				...
				<div class="button" onclick="javacript: return confirm('Yakin hapus?')">
					<?php echo anchor('lapor/hapus_laporan_pengungsi/'.$tampil['id'],'Hapus'); ?>
				</div>
				...
				<div class="button">
					<?php echo anchor('lapor/edit_laporan_pengungsi/'.$tampil['id'],'Edit'); ?>
				</div>
